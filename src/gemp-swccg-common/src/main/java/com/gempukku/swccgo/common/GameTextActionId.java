...
public enum GameTextActionId {
    ...
    CHEWBACCA_OF_KASHYYYK__DOWNLOAD_WUTA_OR_CHEWBACCAS_BOWCASTER(true),
    ...
    DO_OR_DO_NOT_WISE_ADVICE__DOWNLOAD_BOG_CLEARING(true),
    ...
    IM4_099__DEPLOY_TROOPERS_AS_REACT(false, false, false, true),
    ...
    RUNHEB_VOEND__DOWNLOAD_SANDCRAWLER(true, true),
    ...
    SACRIFICE_FOR_SOMETHING_BIGGER__DEPLOY_KANAN(true, true),
    ...
    THE_MANDALORIAN_AND_GROGU__UPLOAD_OR_RETRIEVE_BESKAR_DEFLECTION(true, true),
    ...
    WATCH_OUT_FOR_THAT_CROSSFIRE_BOYS__REDUCE_FORCE_LOSS(false, true),
    ...
    DO_OR_DO_NOT_WISE_ADVICE__DEPLOY_ANAKINS_LIGHTSABER_FROM_LOST_PILE(true, true),
    ...
    THE_FORCE_WILL_BE_WITH_YOU_ALWAYS__DRAW_BOTTOM_CARD_OF_FORCE_PILE(false, true),
    ...
    WARRANT_OFFICER_BACHENKALL__DEPLOY_IMPERIAL_PILOT_FROM_OUTSIDE_DECK(true, true),
